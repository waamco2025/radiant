...
import { buildRadiantGroup } from '../v2/PrimeRadiant.jsx'
...
export default function V3BootScreen({ onComplete, onFading }) {
  ...
  const startBoot = useCallback(() => {
    setPhase('boot')
    setBootText('Initializing network...')
  }, [])

  // Boot text + phase timers
  useEffect(() => {
    if (phase !== 'boot') return
    const t1 = setTimeout(() => setBootText('Loading object graph...'), 1200)
    const t2 = setTimeout(() => setBootText('Establishing provenance links...'), 2400)
    const t3 = setTimeout(() => {
  ...
  return (
    <div style={{
      ...
      <div style={{
        fontSize: 10, letterSpacing: '0.12em', color: 'rgba(212, 175, 55, 0.35)',
        ...
        <div style={{ marginTop: 28, position: 'relative', zIndex: 1, width: 300 }}>
          <div style={{
            ...
            <div style={{ padding: '10px 14px', borderBottom: '1px solid rgba(212, 175, 55, 0.15)' }}>
              ...
              <div style={{ fontSize: 12, fontFamily: 'var(--font-mono, monospace)', color: 'rgba(212, 175, 55, 0.7)', letterSpacing: '0.02em' }}>DONLOE.BOB.J.1384297560</div>
            </div>
            <div style={{ padding: '10px 14px', borderBottom: '1px solid rgba(212, 175, 55, 0.15)' }}>
        ...
        <>
          ...
          <div style={{
            ...
            <div style={{
              ...
              borderRadius: 1, animation: `v3-boot-progress ${BOOT_DURATION / 1000}s ease forwards`,
            }} />
          </div>
        </>
      )}
