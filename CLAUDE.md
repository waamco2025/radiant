...
- **Footer version:** v0.11.30 (bumped during Phase 11.7).
- **Last shipped phase:** Phase 11.7 — Documentation hygiene pass (phase log brought current through Phase 11.6.1; architecture spec body audited and synced; polish-backlog Update Log chronological order verified).
