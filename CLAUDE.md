...
- **Footer version:** v0.11.25 (bumped during Phase 11E.7).
- **Last shipped phase:** Phase 11E.7 — Restore `_showAsProvisional` persistence from acceptance until notification click.
