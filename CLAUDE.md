...
- **Footer version:** v0.11.20 (bumped during Phase 11E.1.7).
- **Last shipped phase:** Phase 11E.1.7 — Step 4 copy expansion + modal max-height + Detail Panel close on Directory Layer + Amend DA zero-Asset gating + #163 filing.
