...
- **Footer version:** v0.11.22 (bumped during Phase 11E.4).
- **Last shipped phase:** Phase 11E.4 — Roll back Claim amendment notifications + two-edge architecture for edge draw-in animation + unify amendment badge copy.
