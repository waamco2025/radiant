...
- **Footer version:** v0.11.19 (bumped during Phase 11E.1.6).
- **Last shipped phase:** Phase 11E.1.6 — DA expiration UX in Response + Amend flows + EA "Never expires" coercion fix + Amend DA title.
