...
>
> Round 17 status: **Phase 16.2 shipped** (Directory seed expansion to 12 mock supplier Actors, 157 new Claims, 628 new DAs, cheap x-spread placement-scaling patch — no force-directed layout). Next: Phase 17.0–17.2 (RFP MVP — factory promotion, supplier discovery + response, buyer review).
