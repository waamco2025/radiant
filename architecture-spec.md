...
>
> Round 17 status: **Phase 16.2.7 shipped** (Mini-card + full-card LOD on Directory + dot/square size tweak). MAX_ZOOM lifted 1.5 → 5.0 unlocks two card-LOD swap thresholds: at zoom ≥ 3.333 Claim dots are replaced by AssetNodeMini overlays; at zoom ≥ 4.375 they swap to full AssetNode. RFP markers stay as hollow squares throughout. Polish-backlog #200 closed. Next: Phase 17.0–17.2 (RFP MVP — factory promotion, supplier discovery + response, buyer review).
