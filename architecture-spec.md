...
>
> Round 17 status: **Phase 16.2.6.6 shipped** (RFP marker rendering polish — zoom-aware outer sizing capped at 22 px on screen, tinted indigo fill via new companion InstancedMesh behind the outline, no more adjacent-marker overlap). Directory still hosts ~22,994 dots + 118 RFP hollow squares across 101 Actors. Next: Phase 17.0–17.2 (RFP MVP — factory promotion, supplier discovery + response, buyer review). Polish-backlog #200 (Directory mini-card swap) remains deferred.
