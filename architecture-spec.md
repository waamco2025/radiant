...
>
> Round 17 status: **Phase 16.2.6.3 shipped** (25 more mock actors + zoom-aware label scaling + RFP hollow-square primitive + wave reveal 3s→2s + top-inset trim 500→475). Directory now hosts ~22,824 dots across 77 Actors. Next: Phase 17.0–17.2 (RFP MVP — factory promotion, supplier discovery + response, buyer review). Polish-backlog #200 (Directory mini-card swap) and #201 (RFP cluster expansion at bottom third) are deferred-future candidates.
