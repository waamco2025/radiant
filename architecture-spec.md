...
>
> Round 17 status: **Phase 16.2.6.2 shipped** (edge buffers + chrome inset + zoom cap 4.0 → 1.5 + non-linear dot scaling + wipe origin bottom-center). Directory still hosts ~21,609 dots total across 52 Actors. Next: Phase 17.0–17.2 (RFP MVP — factory promotion, supplier discovery + response, buyer review).
