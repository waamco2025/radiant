...
#### 8.8.5 Forward pointers

- **Phase 17.0.1** — RFP mini-card + full-card LOD swap, paralleling the Phase 16.2.7 Claim LOD pipeline. Adds RFP hover-preview and pinned tooltip alongside.
