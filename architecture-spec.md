...
>
> Round 17 status: **Phase 16.2.8 shipped** (Directory Claim card population — CLAIM label / minibars / red borders / badges via mock distribution). The Directory's mid- and full-LOD cards now visually match parent-canvas Claim cards. Distribution: 50% no minibar, 20% all-green (10% of which carry 1-4 badges), 15% has-bad (red border), 15% mixed. Next: Phase 16.2.9 (disclosure-type colored borders / tints), then Phase 17.0–17.2 (RFP MVP).
