...
- **Phase 17.3+** — Solicitation withdraw / amend (seller-side); multi-Claim solicitations per (seller, RFP) pair; solicitor-side "open the resulting EA" deep-link from accepted SolicitationCard via `acceptedEaId`.
