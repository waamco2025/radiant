...
>
> Round 17 status: **Phase 16.2.6.5 shipped** (20 RFP-only buyer mock actors + 4 mixed Claims/RFP actors; 118 total RFPs; new ACTOR_KIND taxonomy with bottom-third bias + Lloyd's clamp for RFP-only seeds, cross-zone band for mixed). Directory now hosts ~22,994 dots + 118 RFP hollow squares across 101 Actors. Next: Phase 17.0–17.2 (RFP MVP — factory promotion, supplier discovery + response, buyer review). Polish-backlog #200 (Directory mini-card swap) remains deferred. #201 (RFP cluster expansion) closed by this phase.
